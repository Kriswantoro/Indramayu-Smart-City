...
class RiwayatPengaduan : AppCompatActivity() {
    ...
    fun getRiwayat(status: String, idPengguna: String) {
        val stringRequest = object : StringRequest(
            Method.POST, EndPoint.URL_RIWAYAT_PENGADUAN,
...
//                            val rpengaduanJson = array.getJSONObject(i)
...
//                            val rpengaduan = RiwayatModel(rpengaduanJson.getString("count"))

//                            belum.text = rpengaduan.count
                        }
                    } else {
